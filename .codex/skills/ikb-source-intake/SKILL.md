...
Keep the original file, export, transcript, or document version immutable. Record its path or URL, source message/document IDs, capture time, raw content hash, normalized-records hash, and access scope. Never replace raw source with a summary.
