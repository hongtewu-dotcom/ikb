...
- **Encoding**: No branch dependencies; integration is blocked by all branches
...
- **Encoding**: Each task is blocked by the previous task
...
- **Encoding**: B and C are blocked by A; D is blocked by B and C
...
- **Encoding**: Phase 2 tasks are blocked by all Phase 1 tasks
...
- **Encoding**: B and D are blocked by A; C is blocked by B; E is blocked by D
