...
**Stream 3: Shared Infrastructure** (designated contract owner)
...
- Dependencies: None. Freeze and accept this contract before starting consumer writers.

### Dependency Graph

```
Stream 3 (freeze shared contract) ──→ Stream 1 (login)
