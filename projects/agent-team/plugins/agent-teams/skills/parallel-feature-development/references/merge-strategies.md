...
- Shared type files are owned by the parent or a designated writer and modified sequentially
...
2. **Parent arbitrates**: The parent agent decides which implementation to keep
3. **Tests decide**: The implementation that passes tests is correct
4. **Merge manually**: For complex conflicts, the parent merges after writers stop
