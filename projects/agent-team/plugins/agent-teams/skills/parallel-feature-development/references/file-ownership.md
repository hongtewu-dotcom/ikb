...
- Shared type definitions (owned by the parent or a designated implementer)
...
shared:        src/types/{feature}.ts      (owned by parent/designated owner)
```
...
shared:        types/{feature}.ts          (owned by parent/designated owner)
```
...
shared:        {app}/types.py              (owned by parent/designated owner)
```
